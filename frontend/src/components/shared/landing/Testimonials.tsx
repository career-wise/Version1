  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content: 'CareerWise helped me decide which college majors aligned with my interests and future career goals. The AI provided personalized recommendations that I hadn\'t even considered!'
    },
    {
      id: 2,
      name: 'Mia Rodriguez',
      ...
      image: '/api/placeholder/40/40',
      rating: 4,
      content: 'After graduation, I was overwhelmed with job options. CareerWise analyzed my skills and helped me find roles that were perfect for my background in marketing and design.'
    },
    {
      id: 3,
      name: 'David Chen',
      ...
      image: '/api/placeholder/40/40',
      rating: 5,
      content: 'The resume guidance was a game-changer. After implementing CareerWise\'s suggestions, I started getting callbacks for interviews within a week!'
    }
  ];
