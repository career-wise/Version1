        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                ...
                provide accurate, actionable career advice.
              </p>

              <p className="text-gray-700 leading-relaxed">
                Our team includes career counselors, data scientists, and
                industry professionals who work together to ensure our AI
                recommendations are grounded in real-world insights and
                opportunities.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden">
              <div className="bg-gradient-to-br from-indigo-500 to-purple-600 h-96 flex items-center justify-center relative">
                {/* Overlay */}
                ...
                <div className="relative z-10 text-center text-white p-8">
                  ...
                  <p className="text-lg opacity-90 max-w-sm mx-auto">
                    Our diverse team combines expertise in career counseling,
                    technology, and data science to create innovative solutions.
                  </p>
                </div>
