        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card
              ...
              padding="lg"
            >
              <div className={`w-16 h-16 ${feature.bgColor} rounded-lg flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}>
                {feature.icon}
              </div>
          ...
          <div className="relative">
            <div className="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden">
              <div className="bg-gradient-to-br from-green-400 to-blue-500 h-96 flex items-center justify-center relative">
                ...
                <div className="absolute top-16 right-12 w-2 h-2 bg-white bg-opacity-40 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
                <div className="absolute bottom-12 left-16 w-4 h-4 bg-white bg-opacity-25 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700">Customized career path recommendations</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                <p className="text-gray-700">Skill gap analysis and learning resources</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                <p className="text-gray-700">Industry-specific insights and trends</p>
              </div>
            </div>
          </div>
        </div>
